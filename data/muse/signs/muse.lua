...
,
  ["__remote.prepareHither:_"] = {
  ["line"] = "  --:: `_remote.prepareHither(turtle: \":\", command: \":\")` -> _On client:_ -> `turtle: \":\", command: \":\", xyz, ^:`",
  ["out"] = " `turtle: \":\", command: \":\", xyz, ^:`",
  ["sign"] = "`_remote.prepareHither(turtle: \":\", command: \":\")`  ",
  ["kind"] = "face",
  ["text"] = "On client:",
}
,
