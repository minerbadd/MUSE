...
,
  ...
  ["name"] = "remote",
  ["description"] = "\
Client and server side support for RPCs and client (player) side support for_ `come` _and_ `tail`. -> remote Test functions are provided for out-of-game operations without a network.",
}
,
  ["_move.tracking:_"] = {
