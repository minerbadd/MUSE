...
,
  ["_join_"] = {
  ["line"] = "local role, id, siting = ...; --:- join  -> _Set network mapping with id from turtle nameplate, update turtle_",
  ["sign"] = "join   ",
  ["text"] = "Set network mapping with id from turtle nameplate, update turtle",
  ["kind"] = "cli",
}
,
  ["_map.point:_"] = {
  ["line"] = "--:: map.point(name: \":\", label\":\", trail: \":\"|^:, tx: #:?, ty: #:?, tz: #:?, tf: \":\"?) -> `map.op (\"point\", ...)` -> `\":\"`",
  ["out"] = " `\":\"`",
  ["sign"] = "map.point(name: \":\", label\":\", trail: \":\"|^:, tx: #:?, ty: #:?, tz: #:?, tf: \":\"?)  ",
  ["kind"] = "face",
  ["text"] = "map.op (\"point\", ...)",
}
,
...
,
  ["_dds.map:_"] = {
  ["line"] = "function dds.map() return pairs(IDs) end --:: dds.map() -> Iterator from Muse roles to ComputerCraft IDs_ -> `():`, `{:}, `nil`",
  ["out"] = " `():`, `{:}, `nil`",
  ["sign"] = "dds.map()  ",
  ["kind"] = "face",
  ["text"] = "Iterator from Muse roles to ComputerCraft IDs",
}
,
  [" port"] = {
  ["type"] = "lib",
...
,
  ...
  ["returns"] = " `\":\"` <-\
",
  ["args"] = "name: \":\", label\":\", trail: \":\"|^:, tx: #:?, ty: #:?, tz: #:?, tf: \":\"?",
  ["type"] = "function",
  ["name"] = "map.point",
  ["description"] = "\
map.op (\"point\", ...)",
...
,
  ["_core.report:_"] = {
  ["line"] = "  --:: core.report(level: #:, ...: any) -> _If level less than (elimination) threshold, then report rest as string._ -> `nil`",
  ["kind"] = "face",
...
,
  ["_quit_"] = {
  ["line"] = "--:- quit message -> Set quit flag to message; next core.report throws error to abort operations.  ",
  ["sign"] = "quit message  ",
  ["text"] = "Set quit flag to message; next core.report throws error to abort operations.",
  ["kind"] = "cli",
}
,
  ["_moves.along:_"] = {
...
,
  ["_dds.site:_"] = {
  ["line"] = "  --:: dds.site(site: \":\") -> _Set site, return (qualified) role; only create site file (default current) if needed_ -> `role: \":\"`",
  ["out"] = " `role: \":\"`",
  ["sign"] = "dds.site(site: \":\")  ",
  ["kind"] = "face",
  ["text"] = "Set site, return (qualified) role; only create site file (default current) if needed",
}
,
  ["_attack_"] = {
...
,
  ["_dds.role:_"] = {
  ["line"] = "function dds.role(id) return roles[id] end --:: dds.role(id: #:) ->  _Muse role (label) for a computer ID_ -> `role: \":\"`",
  ["out"] = " `role: \":\"`",
  ["sign"] = "dds.role(id: #:)  ",
  ["kind"] = "face",
  ["text"] = "Muse role (label) for a computer ID",
}
,
  ["_post_"] = {
...
,
  ...
  ["name"] = "remote",
  ["description"] = "\
Client and server side support for RPCs and client (player) side support for_ `come` _and_ `tail`. -> remote Multiple returns are not supported. Errors are caught on servers and provided as error strings to clients. For testing out-of-game, if client and server are the same, there are no network operations.",
}
,
  ["_move.tracking:_"] = {
...
,
  ["_core.message:_"] = {
  ["line"] = "  --:: core.message(level: #:, ...: any) -> _If level less than `status` threshold, report `rest` as string._ -> `nil`",
  ["kind"] = "face",
  ["sign"] = "core.message(level: #:, ...: any)  ",
  ["out"] = " `nil`",
...
,
  ["_fuel_"] = {
  ["line"] = "function turtle.fuel() --:- fuel -> _Returns energy available in turtle slots._",
  ["sign"] = "fuel  ",
  ["kind"] = "cli",
...
,
  ["__launch.actuate:_"] = {
  ["line"] = "  --:: `_launch.actuate(commands: [command: \":\", direction: facing]) -> _Move to boot a GPS host and retrieve floppy._ -> \":\"",
  ["kind"] = "face",
  ["sign"] = "`_launch.actuate(commands: [command: \":\", direction: facing])  ",
  ["out"] = " \":\"",
...
,
  ["_dds.roleID:_"] = {
  ["line"] = "--:: dds.roleID(role: \":\") -> _ID for a Muse role (qualified if need be)_ -> `ID: #:` ",
  ["out"] = " `ID: #:` ",
  ["sign"] = "dds.roleID(role: \":\")  ",
  ["kind"] = "face",
  ["text"] = "ID for a Muse role (qualified if need be)",
}
,
  ["_map.testFacing:_"] = {
...
,
  ["_dds.hosts:_"] = {
  ["line"] = "  --:: dds.hosts() -> _Populates players IDs and labels using a MQ rednet protocol._ -> `nil`",
  ["out"] = " `nil`",
  ["sign"] = "dds.hosts()  ",
  ["kind"] = "face",
...
,
  ["_place.xyzf:_"] = {
  ["line"] = "  --:: place.xyzf(name: \":\"?, index: #:?) -> _Finds indexed situation in name [defaults to current situation]._ -> `xyzf?, order: #:?`",
  ["kind"] = "face",
  ["sign"] = "place.xyzf(name: \":\"?, index: #:?)  ",
  ["out"] = " `xyzf?, order: #:?`",
  ["text"] = "Finds indexed situation in name [defaults to current situation].",
}
,
  ["_suck_"] = {
...
,
  ["__launch.launch:_"] = {
  ["line"] = "  --:: `_launch.launch(commands: [command: \":\", location: \":\", yD: #:?]) -> _Check before journey then launch._ -> \":\"",
  ["kind"] = "face",
  ["sign"] = "`_launch.launch(commands: [command: \":\", location: \":\", yD: #:?])  ",
  ["out"] = " \":\"",
...
,
  ["_remote.callback:_"] = {
  ["line"] = "--:: remote.callback(results: any[]) -> _Default client side handling of server response: just print results as string._ -> `nil`",
  ["out"] = " `nil`",
  ["sign"] = "remote.callback(results: any[])  ",
  ["kind"] = "face",
...
,
  ["_store_"] = {
  ["line"] = "  --:- store name? -> _Persists site `name` in local store and loads local map._ -> `report: \":\"`",
  ["sign"] = "store name?  ",
  ["text"] = "Persists site `name` in local store and loads local map._ -> `report: \":\"",
  ["kind"] = "cli",
}
,
  ["_farm.logs:_"] = {
...
,
  ["_clientReturn:_"] = {
  ["line"] = "  --:: `clientReturn(serverID: #:, resultString: \":\", callback: ():)` -> _Apply callback to deserialized client result._ -> `any`",
  ["out"] = " `any`",
  ["sign"] = "`clientReturn(serverID: #:, resultString: \":\", callback: ():)`  ",
  ["kind"] = "face",
...
,
  ["_launch.op:_"] = {
  ["line"] = "  --:: launch.op(commands: \":\"[]) -> _Command Line Interface._ -> `report: \":\"` &:",
  ["kind"] = "face",
  ["sign"] = "launch.op(commands: \":\"[])  ",
  ["out"] = " `report: \":\"` &:",
...
,
  ["_log_"] = {
  ["line"] = "--:- log level [filename] -> _Set reporting hurdle and optionally save reporting in log file._",
  ["sign"] = "log level [filename]  ",
...
,
  ["_dds.join:_"] = {
  ["line"] = "  --:: dds.join(role: \":\", id: #:) -> _Sets (non-persistent) qualified ID role (label), id given by player._ -> `role: \":\"`",
  ["out"] = " `role: \":\"`",
  ["sign"] = "dds.join(role: \":\", id: #:)  ",
  ["kind"] = "face",
  ["text"] = "Sets (non-persistent) qualified ID role (label), id given by player.",
}
,
  ["_clientMarshall:_"] = {
  ["line"] = "--:: `clientMarshall(server: \":\", command: \":\", arguments: any[])` -> _Serialize server request._ -> `serverID: #:, request: \":\" &: &!`",
  ["out"] = " `serverID: #:, request: \":\" &: &!`",
  ["sign"] = "`clientMarshall(server: \":\", command: \":\", arguments: any[])`  ",
  ["kind"] = "face",
...
",
  ...
  ["name"] = "place.base",
  ["description"] = "\
Return name without site prefix",
}
,
  ["add"] = {
...
,
  ["_remote.hither:_"] = {
  ["line"] = "  --:: remote.hither(turtle: \":\", command: \":\")` -> _On client:_ -> `turtle: \":\", command: \":\", xyz, ^:`",
  ["out"] = " `turtle: \":\", command: \":\", xyz, ^:`",
  ["sign"] = "remote.hither(turtle: \":\", command: \":\")`  ",
  ["kind"] = "face",
  ["text"] = "On client:",
}
,
...
,
  ["__launch.equip:_"] = {
  ["line"] = "  --:: `_launch.equip(direction: facing)` -> _Assemble parts._ -> \":\"",
  ["kind"] = "face",
  ["sign"] = "`_launch.equip(direction: facing)`  ",
  ["out"] = " \":\"",
  ["text"] = "Assemble parts.",
}
,
...
,
  ["_move.ats:_"] = {
  ["line"] = "--:: move.ats(theSituation:situation?) -> _(Current) position and facing string (`\"\"` in game if not turtle)._ -> `xyzf: \":\"`",
  ["kind"] = "face",
  ["sign"] = "move.ats(theSituation:situation?)  ",
  ["out"] = " `xyzf: \":\"`",
  ["text"] = "(Current) position and facing string (`\"\"` in game if not turtle).",
}
,
  ["moves"] = {
  ["type"] = "lib",
...
,
  ["_dds.set:_"] = {
  ["line"] = "  --:: dds.set(site: \":\"?) -> _Write (new) site file, set new qualified IDs[role, set site and return it_ -> `role: \":\"`",
  ["out"] = " `role: \":\"`",
  ["sign"] = "dds.set(site: \":\"?)  ",
  ["kind"] = "face",
  ["text"] = "Write (new) site file, set new qualified IDs[role, set site and return it",
}
,
  ["_remote.tail:_"] = {
...
,
  ["returns"] = " launch, _launch",
  ["kind"] = "module",
  ["type"] = "lib",
  ["name"] = "launch",
  ["description"] = "\
Assemble, launch, and startup GPS computers._ -> launch, _launch",
}
,
  ["_path_"] = {
...
,
  ["_serverApply:_"] = {
  ["line"] = "  --:: `serverApply(clientID: #:, request: \":\")` -> _Request string to request table, return serialized result_. -> `result: \":\"`",
  ["out"] = " `result: \":\"`",
  ["sign"] = "`serverApply(clientID: #:, request: \":\")`  ",
  ["kind"] = "face",
...
,
  ...
  ["name"] = "role",
  ["description"] = "\
ComputerCraft label as MUSE role (may be qualified by_ `site` _for landed turtles)",
}
,
  ["role"] = {
  ["returns"] = " `role: \":\"` <-\
...
,
  ["_place.base:_"] = {
  ["line"] = "--:: place.base(name: \":\") -> _Return name without site prefix_ -> `base: \":\"`",
  ["kind"] = "face",
  ["sign"] = "place.base(name: \":\")  ",
  ["out"] = " `base: \":\"`",
  ["text"] = "Return name without site prefix",
}
,
  ["turtle"] = {
  ["childs"] = {
...
,
  ["_dds.playerID:_"] = {
  ["line"] = "--:: dds.playerID(id: #:?) -> _Isolate global_ -> #:",
  ["out"] = " #:",
  ["sign"] = "dds.playerID(id: #:?)  ",
  ["kind"] = "face",
  ["text"] = "Isolate global",
}
,
...
,
  ["_map.borders:_"] = {
  ["line"] = "  --:: map.borders(target: \":\") -> _Get situation pair elements_ -> `borders, features, position, position &!`",
  ["out"] = " `borders, features, position, position &!`",
  ["sign"] = "map.borders(target: \":\")  ",
  ["kind"] = "face",
  ["text"] = "Get situation pair elements",
}
,
  ["_launch_"] = {
