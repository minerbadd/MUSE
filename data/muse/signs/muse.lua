...
,
  ...
  ["name"] = "remote",
  ["description"] = "\
Client and server side support for RPCs and client (player) side support for_ `come` _and_ `tail`. -> remote, _remote Test functions are provided for out-of-game operations without a network.",
}
,
  ["_move.tracking:_"] = {
...
,
  ["_remote.returns:_"] = {
  ["line"] = "  --:: `remote.returns(serverID: #:, resultString: \":\", callback: ():)` -> _Apply callback to deserialized client result._ -> `any`",
  ["kind"] = "face",
  ["sign"] = "`remote.returns(serverID: #:, resultString: \":\", callback: ():)`  ",
  ["out"] = " `any`",
...
,
  ["_remote.apply:_"] = {
  ["line"] = "  --:: `remote.apply(clientID: #:, request: \":\")` -> _Request string to request table, return serialized result_. -> `result: \":\"`",
  ["kind"] = "face",
  ["sign"] = "`remote.apply(clientID: #:, request: \":\")`  ",
  ["out"] = " `result: \":\"`",
...
,
  ["_come_"] = {
  ["line"] = "  --:- come -> _Turtle towards GPS player position._",
  ["kind"] = "cli",
  ["sign"] = "come  ",
  ["text"] = "Turtle towards GPS player position.",
}
,
  ["_task.op:_"] = {
...
,
  ["_remote.marshall:_"] = {
  ["line"] = "--:: `remote.marshall(server: \":\", command: \":\", arguments: any[])` -> _Serialize server request._ -> `serverID: #:, request: \":\" &: &!`",
  ["kind"] = "face",
  ["sign"] = "`remote.marshall(server: \":\", command: \":\", arguments: any[])`  ",
...
,
  ["_tail_"] = {
  ["line"] = "  --:- tail rate? -> _Turtle every rate seconds towards player._",
  ["kind"] = "cli",
  ["sign"] = "tail rate?  ",
  ["text"] = "Turtle every rate seconds towards player.",
}
,
  ["_porter_"] = {
