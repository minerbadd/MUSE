...
,
  ["_remote.return:_"] = {
  ["line"] = "  --:: `remote.return(serverID: #:, resultString: \":\", callback: ():)` -> _Apply callback to deserialized client result._ -> `any`",
  ["out"] = " `any`",
  ["sign"] = "`remote.return(serverID: #:, resultString: \":\", callback: ():)`  ",
  ["kind"] = "face",
