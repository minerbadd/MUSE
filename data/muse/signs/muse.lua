...
,
  ["_check.open:_"] = {
  ["line"] = "  --:: check.open(testName:\":\", text: \":\") -> _Return object(closure)_ -> `{part:():, close:():}` ",
  ["kind"] = "face",
...
,
  ["_check.all:_"] = {
  ["line"] = "function check.regression(testOrder) --:: check.all(testOrder: \":\"[]) -> _Run ordered test names for regression._ -> `\":\"[]`",
  ["kind"] = "face",
  ["sign"] = "check.all(testOrder: \":\"[])  ",
  ["out"] = " `\":\"[]`",
