...
,
  ["_check.open:_"] = {
  ["line"] = "  --:: check.open(testName:\":\", text: \":\") -> _Return object(closure)_ -> `{part:():, message:(): , close:():}` ",
  ["kind"] = "face",
...
,
  ["_check.regression:_"] = {
  ["line"] = "function check.regression(testOrder) --:: check.regression(testOrder: \":\"[]) -> _Run ordered test names for regression._ -> `\":\"[]`",
  ["kind"] = "face",
