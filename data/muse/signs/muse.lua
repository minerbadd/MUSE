...
,
  ["_move.tracking:_"] = {
  ["line"] = "  --:: move.tracking(enabled: ^:) -> _Set tracking condition and situations, return situations count_ -> `count: ^#:`",
  ["out"] = " `count: ^#:`",
...
,
  ["_check.open:_"] = {
  ["line"] = "  --:: check.open(testName:\":\", text: \":\") -> _Return `check` object(closure)_ -> `{part:():, message:():, close:():}` ",
  ["kind"] = "face",
  ["sign"] = "check.open(testName:\":\", text: \":\")  ",
  ["out"] = " `{part:():, message:():, close:():}` ",
...
,
  ["_move.clone:_"] = {
  ["line"] = "function move.clone() --:: move.clone() -> _Clone current situation_ -> situation",
  ["out"] = " situation",
  ["sign"] = "move.clone()  ",
  ["kind"] = "face",
