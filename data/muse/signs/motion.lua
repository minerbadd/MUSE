...
---@alias recovery  [string,  failure: string,  cause: string,  remaining: number,  xyzf: xyzf,  direction: direction,  operation: string] # For some errors


-- situation:  `{:position:, :facing:, fuel: situation.fuel, level: situation.level}`
---@alias situation {position: position, facing, situation.fuel, situation.level} # Dead reckoning
