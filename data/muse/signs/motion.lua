...
---@alias situation {position, facing, situation.fuel, situation.level} # Dead reckoning
...
-- position:  `{x: #:, y: #:, z: #:}`
---@alias position {number, number, number} # Computercraft co-ordinates (+x east, +y up, +z south)
