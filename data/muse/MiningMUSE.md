...
<a href="https://en.wikipedia.org/wiki/Regression_testing " target="_blank"> regression testing</a> for sets of unit tests in <a href="code/lib/check.html" target="_blank"> `lib/check`</a>. Beware, there there be (a particular kind of) <a href="https://en.wikipedia.org/wiki/Object-oriented_programming"  target="_blank">objects</a>.
