...
Look at the implementation of the <a href="code/lib/map.html#ops" target="_blank"> `lib/map`</a> operations dispatch and then follow a couple of the <a href="code/lib/map.html#commands" target="_blank">links </a> provided there to look at the actual command programs. 
