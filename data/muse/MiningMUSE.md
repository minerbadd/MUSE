...
Given a way to associate names wth numbers, we could make a way to get a service request from a client to a server. The other part of what would be needed is a way to actually provide the service. That's a job for Remote Procedure Call, an action hero you may (or may not) have heard of. 
