...
--:| core: Strings, session state, cloning, error handling, reporting, UI, math, iterators, lowest level turtle support. -> core    --:! {core:[":"]: ():} <- Core Functions Library -> muse/docs/lib/core.md        
