...
local roleq = dds.join(role, tonumber(id)) -- on player as, e.g., `join rover` 3 or `join farmer 4 baylands`
local message = remote.call(roleq, "join", {roleq, id, siting}) -- `dds.join` connected turtle to network
