...
print(6, map.op {"chart", "farm40", "farm40SE", "SE", "64"}); print(6, map.op {"view", "farm40SE"})
--print(6.1, map.op {"chart", "farm40ES", "corner", "ES", "64"}); print(6.1, map.op {"view", "farm40ES"})

print(7, field.fence {"farm40SE:east", "birch"})

print(8, field.make {"path", "farm40SE:pens"})
print(8.1, field.make {"path", "farm40SE:pens", "2"})
print(8.2, field.make {"path", "farm40SE:pens", "2", "6"})
print(8.3, field.make {"path", "farm40SE:canes", "2", "6"})
print(8.4, field.make {"path", "farm40SE:crops", "2", "6"})
print(8.5, field.make {"path", "farm40SE:trees", "2", "6"})

print(9, field.make {"quarry", "farm40SE:trees", "2", "2"})
print(9.1, field.make {"layer", "farm40SE:trees", "2", "2"})
print(9.2, field.make {"cover", "farm40SE:trees", "2", "2"})
print(9.3, field.make {"finish", "farm40SE:trees", "2", "2"})
print(9.4, field.make {"harvest", "farm40SE:trees", "2", "2"})

print(10, field.make {"quarry", "farm40SE:crops", "2", "2"})
print(10.1, field.make {"layer", "farm40SE:crops", "2", "2"})
print(10.2, field.make {"cover", "farm40SE:crops", "2", "2"})
print(10.3, field.make {"finish", "farm40SE:crops", "2", "2"})
print(10.4, field.make {"harvest", "farm40SE:crops", "2", "2"})

print(11, field.make {"quarry", "farm40SE:pens", "2", "2"})
print(11.1, field.make {"layer", "farm40SE:pens", "2", "2"})
print(11.2, field.make {"cover", "farm40SE:pens", "2", "2"})
print(11.3, field.make {"finish", "farm40SE:pens", "2", "2"})
print(11.4, field.make {"harvest", "farm40SE:pens", "2", "2"})

print(12, field.make {"quarry", "farm40SE:canes", "2", "2"})
print(12.1, field.make {"layer", "farm40SE:canes", "2", "2"})
print(12.2, field.make {"cover", "farm40SE:canes", "2", "2"})
print(12.3, field.make {"finish", "farm40SE:canes", "2", "2"})
print(12.4, field.make {"harvest", "farm40SE:canes", "2", "2"})
