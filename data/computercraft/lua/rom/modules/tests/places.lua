...
test.part("2nd place.xyzf", place.xyzf, "test1")
...
text.part("place.nearby", place.nearby, {20,35,40})
text.part("place.erase", place.erase, "test1")
...
test.part("start trail", place.fix, {10, 25, 35, "west"})
