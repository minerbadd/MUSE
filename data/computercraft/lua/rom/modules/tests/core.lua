...
--[[
##Test: `tests/core` for test of common functions
--:? muse/docs/tests/core.txt <- **Test `lib/places`** -> muse/docs/tests/core.md 
```Lua
--]]
...
-- :: core.compose(...: ():): -> Produce function equivqlent to sucessive application of argument functions -> ():  
