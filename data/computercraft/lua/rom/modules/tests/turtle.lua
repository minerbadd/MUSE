...
--:# turtle.fuel -- total energy available in turtle slots
...
turtle.blocking(true) -- the enhanced turtle supports blocking for testing
...
turtle.blocking(2) -- should unblock
